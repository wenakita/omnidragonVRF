...
/**
 * @title OmniDragonFeeManager
 * @dev Consolidated Fee Manager and Market Maker for the OmniDragon ecosystem
 *
 ...
 */
contract OmniDragonFeeManager is IOmniDragonFeeManager, Ownable, Pausable, ReentrancyGuard {
