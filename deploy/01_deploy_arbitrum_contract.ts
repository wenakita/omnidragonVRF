...
const deployArbitrumContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const layerZeroEndpoint = '0x1a44076050125825900e736c501f859c50fE728c'; // LayerZero V2 endpoint for Arbitrum
  const vrfCoordinator = '0x3C0Ca683b403E37668AE3DC4FB62F4B29B6f7a3e'; // VRF V2.5 Plus Coordinator for Arbitrum
  const subscriptionId = '76197290230634444536112874207591481868701552347170354938929514079949640872745';
  const keyHash = '0xe9f223d7d83ec85c4f78042a4845af3a1c8df7757b4997b815ce4b8d07aca68c'; // 30 gwei gas lane
