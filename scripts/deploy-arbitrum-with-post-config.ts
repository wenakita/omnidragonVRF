...
async function main() {
    ...
    console.log("Account balance:", ethers.utils.formatEther(await deployer.provider!.getBalance(deployer.address)));
    ...
    console.log("Contract balance:", ethers.utils.formatEther(contractStatus.balance));
    console.log("Minimum balance:", ethers.utils.formatEther(contractStatus.minBalance));
