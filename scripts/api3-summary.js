...
console.log("🔗 URL: https://market.api3.org");
...
console.log("1. 1% deviation, 24h heartbeat 🌟 RECOMMENDED");
console.log("   Cost: $50-200/month");
console.log("2. 0.5% deviation, 24h heartbeat 💎 PREMIUM");
console.log("   Cost: $100-400/month");
console.log("3. 5% deviation, 24h heartbeat 💰 BUDGET");
